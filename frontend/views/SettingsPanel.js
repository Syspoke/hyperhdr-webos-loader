...
module.exports = kind({
        ...
        {classes: 'moon-hspacing', controlClasses: 'moon-12h', components: [
          {components: [
            ...
            content: 'Install Lut version', components: [
                {content: 'Compressed SDR|HDR|DV [NV12] (@satdx62)', onchange: 'Lut1'},
                {content: 'Uncompressed  SDR|HDR|DV [NV12] (@satdx62)', onchange: 'Lut2'},
                {content: 'Reset', onchange: 'Lut'},
            ]}
          ]},
        ]},
      ]},
  ...
  Lut1: function (sender) {
      ...
      if (sender.active) {
      this.exec("/media/developer/apps/usr/palm/applications/org.webosbrew.hyperhdr.loader/scripts/lut_compressed.sh");
    }
  },
  Lut2: function (sender) {
    ...
    if (sender.active) {
      this.exec("/media/developer/apps/usr/palm/applications/org.webosbrew.hyperhdr.loader/scripts/lut_uncompressed.sh");
    }
  },
  Lut: function (sender) {
    console.info("toggle:", sender);
    ...
    if (sender.active) {
      this.exec("/media/developer/apps/usr/palm/applications/org.webosbrew.hyperhdr.loader/scripts/lut_reset.sh");
    }
  },
